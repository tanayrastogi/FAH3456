...
class BaseModel:
    ...
    def init_parameters(self,):
        ...
        return [k2, k3, k4, k5, k6, alpha, beta, theta, mu]
    ...
    def optimization_function(self, parameters):
        # Parameters
        k2, k3, k4, k5, k6, alpha, beta, theta, mu = parameters
    ...
    def base_result(self, result):
        ...
        print("\n Final parameters for BASE MODEL")
...
if __name__ == "__main__":
    ...
    # # Init paramerets
    # k2, k3, k4, k5, k6, alpha, beta, theta, mu = model.init_parameters()
    # k = np.array([0.0, k2, k3, k4, k5, k6]).reshape(1, 6)
    # # Utility
    # V = model.utility_function(alpha, beta, theta, mu, k)
    # # Probability
